...
export const en: Record<string, string> = {
  ...
  "cardView.browserLiveHint": "This card's browser is up — open it to watch what the agent is doing in there.",
  "cardView.browserHeld": "{name} has the wheel on this card's browser — the agent is meant to stand back.",
  ...
  "preview.stoppedBody": "The server is not listening any more (the card may have been paused or restarted). Restart relaunches it in its own session and opens the tab.",
  "preview.stoppedNoCommand": "This preview has no stored start command — ask the card's agent to start the server again (it will re-announce the link).",
  "preview.restartButton": "Restart",
  "preview.restarting": "Restarting…",
  "preview.restartError": "Could not restart the preview",
  "preview.stopButton": "Stop preview",
  "preview.stopError": "Could not stop the preview",
  "cardView.openPane": "Open the {label}",
  "cardView.closePane": "Close the {label}",
  "cardView.paneBusy": "The agent is working in this card's {label} right now.",
  "cardView.more": "More",
  ...
  "chat.jumpLatest": "Jump to the latest message",
  ...
  "sdk.replyAction": "Answer",
  "sdk.replyingTo": "Answering this decision",
  "sdk.replyCancel": "Leave — send as a loose message",
  "sdk.replyPlaceholder": "Your answer to this decision…",
  "sdk.replyGone": "That decision is no longer pending — what you write goes as a loose message.",
  ...
  "sdk.verb.reasoning": "Reasoning…",
  "sdk.verb.pondering": "Pondering…",
  "sdk.verb.answering": "Answering…",
  "sdk.verb.writing": "Writing…",
  "sdk.verb.running": "Running…",
  "sdk.verb.working": "Working…",
  "sdk.note.preparing": "preparing the session",
  "sdk.note.preparingStill": "still preparing the session",
  "sdk.note.preparingLong": "the session is slow to come up",
  "sdk.note.thinking": "thinking",
  "sdk.note.thinkingStill": "still thinking",
  "sdk.note.thinkingLong": "thinking for a while now",
  "sdk.note.answering": "writing the answer",
  "sdk.note.answeringStill": "still writing",
  "sdk.note.answeringLong": "long answer, still writing",
  "sdk.note.tool": "running a tool",
  "sdk.note.toolStill": "still running",
  "sdk.note.toolLong": "slow tool, still running",
  "sdk.note.working": "working",
  "sdk.note.workingStill": "still working",
  "sdk.note.workingLong": "long turn, still working",
  "sdk.workingWith": "{elapsed} · {note}",
  "sdk.workingWithEffort": "{elapsed} · {note} with {effort}",
  ...
  "vnc.takeControl": "Take control",
  "vnc.takeControlHint":
    "You are only watching: your mouse and keyboard do not reach the page, and the amber dot is the agent's mouse. Click to take the wheel — the agent is told to stand back.",
  "vnc.release": "Give it back",
  "vnc.releaseHint": "You are driving. Click to hand the browser back to the agent and go back to watching.",
  "vnc.otherDrives": "{name} is driving",
  "vnc.otherDrivesHint": "{name} has the wheel on this browser. Wait for them to hand it back.",
  ...
  "vnc.intro":
    "The card's own Chromium, live. You watch by default — the agent drives, and the amber dot shows where it clicks. When you need the keyboard (a password, a captcha), hit \"Take control\".",
  ...
  "brain.scopeAria": "Brain scope",
  "brain.scopeGlobal": "Global — every card",
  "brain.projectDescription":
    "This project's own instructions, written as CLAUDE.local.md at the root of each of its card worktrees — only this project's cards read it, on top of the global brain and the repository's CLAUDE.md. The '## Aprendizados' section is where vibehub_brain_learn appends what the agents discover; prune it here like any other text.",
  "brain.projectPlaceholder": "This project has no brain yet. Write its rules here — or let the cards record learnings with vibehub_brain_learn.",
  "brain.projectStampNever": "no project brain saved yet",
  "brain.projectSubject": "Project brain ({name})",
  "brain.clearedSubject": "Project brain ({name}) cleared —",
  "brain.clear": "Clear",
  "brain.clearTitle": "Remove this project's brain (deletes its CLAUDE.local.md from the worktrees)",
  "brain.applyProjectTitle": "Rewrite it in every worktree of this project, without saving a new text",
  "brain.appliedToCards": "Applied to {n} worktree(s)",
