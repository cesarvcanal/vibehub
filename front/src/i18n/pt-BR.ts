...
export const ptBR: Record<string, string> = {
  ...
  "access.description": "Quem entra nesta instalação. Você cria a conta e passa usuário e senha — não existe cadastro nem convite por e-mail.",
  "access.memberDescription": "Sua conta nesta instalação.",
  "access.people": "Pessoas",
  "access.empty": "Ninguém além de você tem conta aqui ainda.",
  "access.you": "(você)",
  "access.role": "Papel",
  "access.roleOf": "Papel de {name}",
  "access.roleOwner": "Dono",
  "access.roleMember": "Membro",
  "access.invite": "Nova conta",
  "access.inviteHint": "Dono manda na instalação inteira. Membro só vê o que for compartilhado com ele — nada, até você compartilhar.",
  "access.username": "Usuário",
  "access.password": "Senha",
  "access.newPassword": "Nova senha",
  "access.createUser": "Criar conta",
  "access.resetPassword": "Trocar a senha",
  "access.resetPasswordFor": "Trocar a senha de {name}",
  "access.remove": "Remover",
  "access.removeUser": "Remover {name}",
  "access.removeConfirm": "Remover {name}? Ele perde o acesso a esta instalação na hora.",
  "access.created": "{name} já pode entrar",
  "access.updated": "Conta atualizada",
  ...
  "cardView.browserLiveHint": "O navegador deste card está no ar — abra pra ver o que o agente está fazendo lá.",
  "cardView.browserHeld": "{name} está no controle do navegador deste card — o agente não deve mexer nele agora.",
  "cardView.shell": "Shell",
  "preview.label": "Preview",
  "preview.hint": "Abra um app rodando no runner em uma nova aba",
  "preview.detected": "Escutando no runner",
  "preview.loading": "Escaneando portas…",
  "preview.error": "Não deu pra escanear o runner",
  "preview.none": "Nada escutando — suba um servidor no terminal primeiro",
  "preview.manualPlaceholder": "Porta",
  "preview.open": "Abrir",
  "preview.baseHint": "Os apps são servidos sob /preview/<porta>/. Se os assets derem 404, configure o base path do app — veja docs/preview.md.",
  ...
  "preview.stoppedBody": "O servidor não está mais escutando (o card pode ter sido pausado ou reiniciado). Reiniciar relança o servidor numa sessão própria e abre a aba.",
  "preview.stoppedNoCommand": "Esse preview não tem comando de start registrado — peça ao agente do card pra subir o servidor de novo (ele reanuncia o link).",
  "preview.restartButton": "Reiniciar",
  "preview.restarting": "Reiniciando…",
  "preview.restartError": "Não deu pra reiniciar o preview",
  "preview.stopButton": "Parar preview",
  "preview.stopError": "Não deu pra parar o preview",
  "cardView.openPane": "Abrir o {label}",
  "cardView.closePane": "Fechar o {label}",
  "cardView.paneBusy": "O agente está mexendo no {label} deste card agora.",
  "cardView.more": "Mais",
  ...
  "chat.jumpLatest": "Ir para a mensagem mais recente",
  ...
  "sdk.replyAction": "Responder",
  "sdk.replyingTo": "Respondendo a esta decisão",
  "sdk.replyCancel": "Sair — mandar como mensagem solta",
  "sdk.replyPlaceholder": "Sua resposta a esta decisão…",
  "sdk.replyGone": "Essa decisão não está mais pendente — o que você escrever vai como mensagem solta.",
  ...
  "sdk.verb.reasoning": "Raciocinando…",
  "sdk.verb.pondering": "Elaborando…",
  "sdk.verb.answering": "Respondendo…",
  "sdk.verb.writing": "Escrevendo…",
  "sdk.verb.running": "Executando…",
  "sdk.verb.working": "Trabalhando…",
  "sdk.note.preparing": "preparando a sessão",
  "sdk.note.preparingStill": "ainda preparando a sessão",
  "sdk.note.preparingLong": "a sessão está demorando a subir",
  "sdk.note.thinking": "pensando",
  "sdk.note.thinkingStill": "ainda pensando",
  "sdk.note.thinkingLong": "pensando faz tempo",
  "sdk.note.answering": "escrevendo a resposta",
  "sdk.note.answeringStill": "ainda escrevendo",
  "sdk.note.answeringLong": "resposta longa, ainda escrevendo",
  "sdk.note.tool": "rodando ferramenta",
  "sdk.note.toolStill": "ainda rodando",
  "sdk.note.toolLong": "ferramenta demorada, ainda rodando",
  "sdk.note.working": "trabalhando",
  "sdk.note.workingStill": "ainda trabalhando",
  ...
  "vnc.takeControl": "Assumir controle",
  "vnc.takeControlHint":
    "Você está só assistindo: seu mouse e teclado não entram na página, e o ponto laranja é o mouse do agente. Clique para pegar o controle — o agente é avisado para não mexer enquanto isso.",
  "vnc.release": "Devolver ao agente",
  "vnc.releaseHint": "Você está no controle. Clique para devolver o navegador ao agente e voltar a só assistir.",
  "vnc.otherDrives": "{name} no controle",
  "vnc.otherDrivesHint": "{name} está com o controle deste navegador. Espere devolverem para assumir.",
  ...
  "vnc.intro":
    "O Chromium do próprio card, ao vivo. Por padrão você só assiste — o agente dirige e o ponto laranja mostra onde ele clica. Quando precisar (uma senha, um captcha), clique em \"Assumir controle\".",
